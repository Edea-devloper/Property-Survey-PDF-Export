                            ...
                            {section_42_data?.data?.flags?.map((isChecked : any, index : any) => {
                                ...
                                return (
                                    <tr key={index} className={styles['section4_2']}>
                                        <td style={{ paddingRight: '25px', direction: 'ltr' }}>{matchedChapter ? `${matchedChapter.Chapter},${matchedChapter.Order0 - 420}` : '-'}</td>
                                        ...
                                        {/* <td colSpan={4} style={{ width: '350px' }}><textarea rows={4} readOnly style={{ height: '90px', direction: 'rtl' }}>{stripHtmlTags(section_42_data?.data?.rows[index][1])}</textarea></td> */}
