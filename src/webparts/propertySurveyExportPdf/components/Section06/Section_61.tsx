                                    ...
                                    <tr key={index} className={styles['section6_1']}>
                                        ...
                                        <td>
                                            <div className={styles.readOnlyField}>
                                                {section_61_data?.data?.rows[index][5]}
                                            </div>
                                        </td>

                                        <td>
                                            <div className={styles.readOnlyField}>
                                                {section_61_data?.data?.rows[index][2]}
                                            </div>
                                        </td>

                                        <td colSpan={4} style={{ width: '175px' }}>
                                            <div className={styles.readOnlyFieldTextarea}>
                                                {section_61_data?.data?.rows[index][4]}
                                            </div>
                                        </td>

                                        <td colSpan={2}  style={{ width: '150px' }}>
                                            <div className={styles.readOnlyField}>
                                                {section_61_data?.data?.rows[index][1]}
                                            </div>
                                        </td>

                                        <td colSpan={4} style={{ width: '175px', paddingLeft: '21px' }}>
                                            <div className={styles.readOnlyFieldTextarea}>
                                                {section_61_data?.data?.rows[index][10]}
                                            </div>
                                        </td>
