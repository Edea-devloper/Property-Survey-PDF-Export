                            ...
                            {section_55_data?.data?.flags?.map((isChecked: any, index: any) => {
                                ...
                                return (
                                    <tr key={index} className={styles['section5_2_1']}>
                                        <td style={{ paddingRight: '25px', direction: 'ltr' }}>{matchedChapter ? `${matchedChapter.Chapter},${matchedChapter.Order0 - 479}` : '-'}</td>
                                        ...
                                        {/* <td colSpan={4} style={{ width: '350px' }}><textarea style={{ height: '90px', direction: 'rtl' }} rows={4} readOnly>{section_55_data?.data?.rows[index][1]}</textarea></td> */}
