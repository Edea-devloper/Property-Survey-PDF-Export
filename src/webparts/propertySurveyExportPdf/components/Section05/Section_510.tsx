...
const Section_510: React.FC<Section521Props> = ({
    section_521_data,
    chapter_data_521,
        ...
        <>
            <div>
                <div className={styles['container-section']}>
                    <div className={`${styles.header} ${styles.h_direction_51} chunkrowTitle`}>5.10 - אחר</div>
                    <table id='table521' className={styles['custom-table']} style={{display: 'none'}}>
                            ...
                            {section_521_data?.data?.flags?.map((isChecked: any, index: any) => {
                                ...
                                return (
                                    <tr key={index} className={styles['section5_2_1']}>
                                        ...
                                        {/* <td style={{ width: '150px' }}><input type="text" value={section_521_data?.data?.rows[index][4]} readOnly /></td> */}
                                        <td style={{ width: '150px' }}><input type="text" value={section_521_data?.data?.rows[index][3]} readOnly /></td>
                                        ...
                                        <td colSpan={4} style={{ width: '350px' }}><textarea style={{ height: '90px', direction: 'rtl' }} rows={4} readOnly>{section_521_data?.data?.rows[index][1]}</textarea></td>
