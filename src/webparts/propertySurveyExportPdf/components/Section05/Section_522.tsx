...
const Section_522: React.FC<Section521Props> = ({
    section_521_data,
    chapter_data_521,
        ...
        <>
            <div>
                <div className={styles['container-section']}>
                    <div className={`${styles.header} ${styles.h_direction_51} chunkrowTitle`}>5.2.2 -  קירות חיצוניים</div>
                    <table id='table522' className={styles['custom-table']}>
